    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading title="Create FAQ" description="Create a new FAQ entry" className="mb-0" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div className="col-span-1 md:col-span-8 space-y-5">
                            ...
                            <div className="flex justify-end">
                                <Button asChild variant="outline" className="mr-2" type='button'>
                                    <Link href={route('admin.faqs.index')} className="flex items-center">Cancel</Link>
                                </Button>
