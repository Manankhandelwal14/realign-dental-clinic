...
<head>
    ...
    <title>ReAlign Dental Clinic - Website Under Construction </title>
    {{-- seo --}}
...
<body class="bg-black min-h-screen flex flex-col items-center justify-center p-4 overflow-x-hidden">
    ...
    <div class="content max-w-4xl mx-auto text-center">
        ...
        <div class="transform hover:scale-105 transition-transform duration-300" id="logo-container">
            <img src="{{ asset('images/logo/logo-png.png') }}" alt="ReAlign Dental Clinic Logo"
                class="w-48 md:w-64 mx-auto floating" loading="lazy">
        </div>

        {{-- ReAlign Dental Clinic --}}
        <h1 class="text-[#C6A962] text-sm md:text-xl font-bold mb-4 uppercase" id="coming-soon-text">
            ReAlign Dental Clinic
        </h1>
        <!-- Coming Soon Text -->
        <h1 class="text-[#C6A962] text-4xl md:text-6xl font-bold mb-4" id="coming-soon-text">
            Website Under Construction
        </h1>

        <!-- Description -->
        <p class="text-[#C6A962]/80 text-lg md:text-xl mb-8 max-w-2xl mx-auto" id="description">
            Experience excellence in dental care. We're preparing something special for you.
        </p>

        <!-- Contact Information -->
        <div class="text-[#C6A962]/80 mb-8" id="contact-info">
            <p class="mb-2">Contact us: <a href="tel:+917891012206" class="hover:text-[#C6A962] transition-colors">+91
                    7891012206</a></p>
        </div>
        ...
        <div class="flex justify-center gap-6 mb-8" id="social-links">
            <a href="https://www.instagram.com/realigndentalclinic/" target="_blank" rel="noopener noreferrer"
                class="text-[#C6A962]/80 hover:text-[#C6A962] transition-colors transform hover:scale-110"
    ...
    <script>
        ...
        // Countdown Timer
        const launchDate = new Date('2025-02-05T00:00:00').getTime();
